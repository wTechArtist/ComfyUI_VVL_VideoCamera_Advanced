...
from .comfyui_vggt_native_nodes import VGGTNativeFullOutputNode
from .comfyui_vggt_mask_processor import VGGTMaskProcessorNode
from .vggt_model_loader import VVLVGGTLoader
# 以下节点已迁移到 ComfyUI_VVL_DataProcessing 插件
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "VGGTNativeFullOutputNode": "🔬 VGGT 原生完整输出",
    "VGGTMaskProcessorNode": "🎭 VGGT Mask分割处理器",
    # 以下节点已迁移到 ComfyUI_VVL_DataProcessing 插件
